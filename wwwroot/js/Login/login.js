...
$(document).ready(function () {
    ...
    if ($("#registroForm").length > 0) { //si esta en el documento de creacion de perfil
        ...
        var apiProvincia = "https://www.apprh.somee.com/api/HelloWorld/Provincias";
    ...
    $("#provincias").change(function () {
        if ($("#provincias").val() != "null") {//verificar que la opcion no sea "seleccione una provincia"
            ...
            const apiCanton = 'https://www.apprh.somee.com/api/HelloWorld/Cantones/';
    ...
    $("#cantones").change(function () {
        ...
        const apiDistrito = 'https://www.apprh.somee.com/api/HelloWorld/Distritos/';
